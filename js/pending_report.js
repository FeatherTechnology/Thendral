$(document).ready(function () {
    ...
    $('#pending_report_btn').click(function () {
        ...
        $('#pending_report_table').DataTable().destroy();
        $('#pending_report_table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'api/report_files/get_pending_report.php',
                'data': function (data) {
            ...
            swalError('Warning', 'Please Fill The Date!');
